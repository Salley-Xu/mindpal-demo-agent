...
class Config:
    ...
    ENABLE_DENSE_RETRIEVAL: bool = os.getenv("ENABLE_DENSE_RETRIEVAL", "true").lower() == "true"
    ...
    RECOMMEND_GATE_HELP_INTENT_HARD_THRESHOLD: float = float(os.getenv("RECOMMEND_GATE_HELP_INTENT_HARD_THRESHOLD", "0.38"))
    RECOMMEND_GATE_SOFT_THRESHOLD: float = float(os.getenv("RECOMMEND_GATE_SOFT_THRESHOLD", "0.20"))
    # 冷却惩罚（hard/soft 区分）
    RECOMMEND_GATE_COOLDOWN_SOFT_D1: float = float(os.getenv("RECOMMEND_GATE_COOLDOWN_SOFT_D1", "0.35"))
    RECOMMEND_GATE_COOLDOWN_SOFT_D2: float = float(os.getenv("RECOMMEND_GATE_COOLDOWN_SOFT_D2", "0.18"))
    RECOMMEND_GATE_COOLDOWN_HARD_D1: float = float(os.getenv("RECOMMEND_GATE_COOLDOWN_HARD_D1", "0.50"))
    RECOMMEND_GATE_COOLDOWN_HARD_D2: float = float(os.getenv("RECOMMEND_GATE_COOLDOWN_HARD_D2", "0.25"))
    ...
    BERT_MODEL_PATH: str = os.getenv("BERT_MODEL_PATH", "bert_data/models/v4_2_domain_only_v2/best_model")
