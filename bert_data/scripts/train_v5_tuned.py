...
数据：bert_data/processed_v4/train_v5_expansion.jsonl（1027 条）
...
class Config:
    train_path = "bert_data/processed_v4/train_v5_expansion.jsonl"
    output_dir = "bert_data/models/v5_tuned"
